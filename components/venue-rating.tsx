...
export default function VenueRating({ rating, ratingCount, userCanRate = true, venueId }: VenueRatingProps) {
    ...
    <div className="flex items-center">
      ...
      {userCanRate && (
        <Dialog open={isRatingOpen} onOpenChange={setIsRatingOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Mekanı Değerlendir</DialogTitle>
              <DialogDescription>Bu mekan hakkında ne düşünüyorsunuz? Yıldız vererek değerlendirin.</DialogDescription>
            </DialogHeader>
